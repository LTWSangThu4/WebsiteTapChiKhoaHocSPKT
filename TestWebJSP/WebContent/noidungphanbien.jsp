						...
						<nav class="navbar navbar-default" style="background: #0a408a;">
							...
							<div class="navbar-collapse collapse" id="main-menu">
								<ul class="nav nav-justified " >
										<li><a class="textcolor" href="noidungphanbien.jsp"><strong>Trang chủ</strong></a></li>
								...
								<div class="panel-body">
										...
										<!--cot trái-->
											<div class="col-md-8">
												...
												<form id="FormPhanBien" method="post" action="" class="form-horizontal">
													...
													<div class="form-group">
													    ...
													    <div class="col-sm-9">
													      <textarea class="form-control" rows="5" id="noidung" placeholder="Nhập nội dung phản biện"></textarea>
													    </div>
													  </div>
													 <div class="form-group">
													  ...
													  <div class="col-sm-offset-3">
													  	<button type="button" id="guiphanbien" class="btn btn-primary">Gửi Phản Biện</button>	
													  </div>
