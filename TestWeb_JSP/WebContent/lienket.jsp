								...
								<div class="col-md-12">
									...
									<!--Ajax-->	
									  <script type="text/javascript">
										 ...
										 e.preventDefault();
										 $('#nd2-canlay').load('ketquatimkiem.jsp #ndtk-canlay');
										 });
										 });
									</script>
				  				<!--endAjax-->
								...
								<div class="panel-body">
									<div class="jumbotron">
									  ...
									  <div class="form-group">
									    ...
									    <div class="col-sm-9">
									      <a href="http://hcmute.edu.vn" target="_blank">hcmute.edu.vn</a>
									    </div>
									  </div>
									  ...
									  <div class="form-group">
									    ...
									    <div class="col-sm-9">
									      <a href="http://Online.hcmute.edu.vn" target="_blank">Online.hcmute.edu.vn</a>
									    </div>
									  </div>
									  <div class="form-group">
									    <label class="col-sm-3">DKMH:</label>
									    <div class="col-sm-9">
									      <a href="http://dkmh.hcmute.edu.vn" target="_blank">dkmh.hcmute.edu.vn</a>
									    </div>
									  </div>
